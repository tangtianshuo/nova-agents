...
export const FS_PATHS = {
    USER_SKILLS_DIR: '~/.nova-agents/skills/',
    USER_COMMANDS_DIR: '~/.nova-agents/commands/',
    PROJECT_SKILLS_DIR: '.claude/skills/',
    PROJECT_COMMANDS_DIR: '.claude/commands/',
    USER_AGENTS_DIR: '~/.nova-agents/agents/',
...
export const CUSTOM_EVENTS = {
    ...
    /** Fired to launch AI bug report: opens new Chat tab with ~/.nova-agents workspace */
