...
const NOVA_AGENTS_DIR = join(homedir(), '.nova-agents');
const SESSIONS_FILE = join(NOVA_AGENTS_DIR, 'sessions.json');
const SESSIONS_DIR = join(NOVA_AGENTS_DIR, 'sessions');
const ATTACHMENTS_DIR = join(NOVA_AGENTS_DIR, 'attachments');
const SESSIONS_TMP_FILE = join(NOVA_AGENTS_DIR, 'sessions.json.tmp');
 ...
 */
const SESSIONS_LOCK_FILE = join(NOVA_AGENTS_DIR, 'sessions.lock');
