...
export default memo(function TabBar({
    ...
    return (
        <div className="flex h-full flex-1 items-center gap-0.5 select-none overflow-hidden">
            ...
            {canAddTab && (
                <button
                    className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg transition-all duration-150 text-[var(--ink-muted)] hover:bg-white/10 hover:text-[var(--ink)]"
                    onClick={onNewTab}
                    title="新建标签页"
                >
