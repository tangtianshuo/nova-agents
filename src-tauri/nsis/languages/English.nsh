; English language file for nova-agents NSIS Installer
...
LangString alreadyInstalledLong ${LANG_ENGLISH} "nova-agents $R5 is already installed.$\n$\nYou can choose to reinstall or uninstall."
...
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "nova-agents $R5 is already installed. You are about to install nova-agents ${VERSION}.$\n$\nYou can proceed with the upgrade directly."
