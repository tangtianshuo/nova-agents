// System tray implementation for NovaAgents
...
pub fn setup_tray<R: Runtime>(app: &tauri::App<R>) -> Result<(), Box<dyn std::error::Error>> {
    // Build the tray menu
    let open_item = MenuItemBuilder::with_id(MENU_OPEN, "打开 NovaAgents").build(app)?;
...
/// Reads from ~/.nova-agents/config.json, defaults to false if not configured
#[allow(dead_code)]
